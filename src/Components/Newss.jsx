   ...
   <div className="mainContainer" style={{
    ...
    <div className={styles.News}>
     ...
     <div className={styles.first}>
       <a href="">
         <span className={styles.span}>{">"}</span> Scorecard: Mumbai Vs Delhi 
       </a>
       <h6
         style={{
           marginLeft: "70px",
       ...
       >
         ...
         <div className={styles.top1}>
           ...
           >
             The former India captain will have a point to prove come August 28
       ...
       <a href="https://www.espncricinfo.com/series/ranji-trophy-2021-22-2022-1280196/bengal-vs-madhya-pradesh-1st-semi-final-1313307/live-cricket-score">
         <span className={styles.span}>{">"}</span> Scorecard: Bengal Vs Madhya
         Pradesh
       </a>{" "}
       <hr />
     ...
     <div className={styles.first}>
       ...
       >
         ...
         >
           TV coverage in Bangladesh unlikely for Antigua Test TV coverage in
           Bangladesh unlikely for Antigua Test This could be the first time
           since 2001 that a Test in which Bangladesh are playing in will not
           be shown at home
         </div>
       </div>
       <hr />
       ...
       <a href="">
         <span className={styles.span}>{">"}</span>Back injury sidelines Yasir
         Ali
       </a>
       <div>
         <a href="">
...
{/* neeeeeeeeeewwwwwwwwwwwwwwwww         ends here */}
     <div className={styles.first}>
       ...
       >
         {" "}
         Fast Bowler Likely to make debut Vs NZ as England manage workLoads
       </h5>
     </div>
     ...
     <div className={styles.first}>
       ...
       >
         His exit follows that of seamer Peter Chase who hung up his boots last
         week
       </h4>
     </div>
     ...
     <div className={styles.first}>
       ...
       >
         Hazlewood is No. 1 T20I bowler; Kishan highest-rated India batter
       </h3>
       <h4
         style={{
           // marginLeft: "70px",
       ...
       >
         The last Australia bowler to top the bowling charts was Bracken in
         2021
       </h4>{" "}
       <hr />
       <div
       ...
       >
         ...
         >
           ...
           Root rises to No. 1 in Tests; Imam moves past Kohli to No. 2 in ODIs
           Replaces Labuschagne at the top following his 176 in Trent Bridge
         </div>
       </div>
     </div>
     ...
     <div className={styles.first}>
       ...
       >
         ...
         <h4 style={{
           ...
           And when we're not all agog for Boult vs Anderson, we're waiting to
           see whether Jay-Z will bring Brooklyn's finest PR skills to our game
         </h4>
       </div>
     </div>
   </div>
